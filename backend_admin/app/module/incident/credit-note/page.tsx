...
import { fetchCreditNotes } from '@/app/data/credit-note';
import { creditNoteColumns } from '@/app/config/BillingsTableConfig';
...
export default function CreditNotePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Table */}
      <GenericTablePage
        fetchDataCursor={fetchCreditNotes}
        columns={creditNoteColumns(router)}
        config={{
