// app/(auth)/login/variants/LoginVariant2.tsx
'use client';
...
export default function Variant2() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cover bg-center relative"
      style={{ backgroundImage: `url('${AUTH_IMAGES.loginBg}')` }} // 🔹 put your bg image in /public
    >
      {/* Overlay */}
      <div className="absolute inset-0 bg-black/50"></div>

      {/* Form Container */}
      <div className="relative z-10 w-full max-w-md p-8 bg-white/90 backdrop-blur-md rounded-xl shadow-2xl">
        {/* Logo */}
        <div className="text-center mb-6">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-blue-600 rounded-full shadow-lg mb-3">
            <Lock className="w-8 h-8 text-white" />
          </div>
          <h1 className="text-3xl font-bold text-gray-900">{APP_CONSTANT.name}</h1>
          <p className="text-gray-600">Client Operations</p>
        </div>
