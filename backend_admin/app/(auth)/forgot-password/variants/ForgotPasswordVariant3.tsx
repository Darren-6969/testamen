// app/(auth)/forgot-password/variants/ForgotPasswordVariant3.tsx
'use client';
...
export default function ForgotPasswordVariant3() {
      ...
      <div className="flex items-center justify-center bg-white px-8 py-12">
        <div className="max-w-md w-full">
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 text-sm">We’ll send a reset link to your email.</p>
          </div>
